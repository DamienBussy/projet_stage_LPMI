 ...
 */
    ...
    //     // On écrit la requête
    //     $sql = "UPDATE commande SET id_centre = :id_centre, id_fournisseur = :id_fournisseur, commandeId = :commandeId, dateLivraison = :dateLivraison, montantHT = :montantHT WHERE id_commande = :id";
        
    //     // On prépare la requête
    //     $query = $this->connexion->prepare($sql);
        
    //     // On attache les variables
    //     $query->bindParam(':id_centre', $this->id_centre);
    //     $query->bindParam(':id_fournisseur', $this->id_fournisseur);
    //     $query->bindParam(':commandeId', $this->commandeId);
    //     $query->bindParam(':dateLivraison', $this->dateLivraison);
    //     $query->bindParam(':montantHT', $this->montantHT);
